        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <Input id="name" placeholder="Ex: Copa Biblica Nacional 2025" value={name} onChange={(e) => setName(e.target.value)} required />
            </div>
            ...
            <Button type="submit" size="lg" className="gradient-primary text-primary-foreground gap-2 mt-2">
              <Save className="h-5 w-5" /> Criar Torneio
            </Button>
          </form>
        </CardContent>
      </Card>
